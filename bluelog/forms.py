...
class PostForm(FlaskForm):
    ...
    category = SelectField('Category', coerce=int, default=1)  # coerce设为int，表示强制使用int类型
...
class CommentForm(FlaskForm):
    ...
    site = StringField('Site', validators=[Optional(), URL(), Length(0, 255)])  # 可选参数, 最小长度为0
