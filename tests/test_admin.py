...
class AdminTestCase(BaseTestCase):
    ...
    def setUp(self):
        ...
        post = Post(title='Hello', category=category, body='Testing...')
    ...
    def test_new_post(self):
        ...
        response = self.client.post(url_for('admin.new_post'),
                                    data=dict(
                                        title='Something',
                                        category=1,
                                        body='hello flask'
    ...
    def test_edit_post(self):
        ...
        response = self.client.post(url_for('admin.edit_post', post_id=1),
                                    data=dict(
                                        title='Edit title',
                                        body='New post body',
                                        category=1
    ...
    def test_enable_comment(self):
        ...
        data = response.get_data(as_text=True)
        self.assertIn('<div id="comment-form">', data)  # 有评论表单
    ...
    def test_disable_comment(self):
        ...
        response = self.client.post(url_for('blog.show_post', post_id=1))
        data = response.get_data(as_text=True)
        self.assertNotIn('<div id="comment-form">', data)  # 没有评论表单
    ...
    def test_blog_setting(self):
        response = self.client.post(url_for('admin.settings'),
                                    data=dict(
                                        name='Jack',
                                        blog_title='My Blog',
                                        blog_sub_title='My tech note',
                                        bio='I am ...',
